...
export const refreshToken = async (data: FormData): Promise<TokenResponse | undefined> => {
  ...
  try {
    const res = await fetch(`https://профижкх.рф/api/v1/auth/refresh`, {
      method: "POST",
      headers: {
        "Content-Type": "application/json"
      },
...
export const passwordForgot = async (data: FormData): Promise<void> => {
  ...
  const res = await fetch("https://профижкх.рф/api/v1/auth/password/forgot", {
    method: "POST",
    headers: {
      "Content-Type": "application/json"
    },
...
export const passwordRestore = async (requestBody: { token: string, password: string }): Promise<void> => {
  try {
    const res = await fetch(`https://профижкх.рф/api/v1/auth/password/restore`, {
      method: "POST",
      headers: {
        "Content-Type": "application/json"
      },
