...
import checkOfAgentIcon from '@/public/assets/icons/checkOfAgent.svg'
import daidjestIcon from '@/public/assets/icons/daidjestIcon.svg'
    ...
    return (
        <div className="flex flex-col items-center justify-center gap-12 h-full">
            <div className="flex flex-col gap-y-5">
                ...
                {actionType === null ? (
                    <div className="grid grid-cols-1 items-stretch gap-6 max-w-6xl px-6  md:px-0 md:grid-cols-2 lg:max-h-96 lg:overflow-y-auto lg:grid-cols-3">
